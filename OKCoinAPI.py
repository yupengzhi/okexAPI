...
class OKCoinMarketAPI(OKCoinBase):
    ...
    def depth(self, symbol, contract_type, size=0, merge=0, future_or_spot=True):
        ...
        return self._request.get(OKCoinBase.RESOURCES_URL['depth'].format('future_' if future_or_spot else ''),
                                  params)
    ...
    def trades(self, symbol, contract_type, future_or_spot=True):
        ...
        params = OKCoinMarketAPI.build_request_string('symbol', symbol, '', OKCoinBase.Symbols)
        params = OKCoinMarketAPI.build_request_string('contract_type', contract_type, params, OKCoinBase.ContractType)
        return self._request.get(OKCoinBase.RESOURCES_URL['trades'].format('future_' if future_or_spot else ''),
                                  params)
...
class OKCoinDealsAPI(OKCoinBase):
    ...
    def future_user_info(self):
        ...
        return HttpsRequest.post(self,OKCoinBase.RESOURCES_URL['user_info'], params)
    ...
    def future_position(self, symbol, contract_type):
        ...
        params['sign'] = HttpsRequest.build_sign(params, self._secret_key)
        return HttpsRequest.post(self,OKCoinBase.RESOURCES_URL['position'], params)
    ...
    def future_trade(self, symbol, contract_type, price='', amount='', trade_type='', match_price='', lever_rate=''):
        ...
        if price:
            params['price'] = price
        params['sign'] = HttpsRequest.build_sign(params, self._secret_key)
        return HttpsRequest.post(self,OKCoinBase.RESOURCES_URL['trades'], params)
    ...
    def future_trade_history(self, symbol, date, since):
        ...
        params['sign'] = HttpsRequest.build_sign(params, self._secret_key)
        return HttpsRequest.post(self,OKCoinBase.RESOURCES_URL['trades_history'], params)
    ...
    def future_user_info_4fix(self):
        params = {'api_key': self._api_key}
        params['sign'] = HttpsRequest.build_sign(params, self._secret_key)
        return HttpsRequest.post(self,OKCoinBase.RESOURCES_URL['user_info_4fix'], params)
    ...
    def future_position_4fix(self, symbol, contract_type, trade_type):
        ...
        params['sign'] = HttpsRequest.build_sign(params, self._secret_key)
        return HttpsRequest.post(self,OKCoinBase.RESOURCES_URL['position_4fix'], params)
